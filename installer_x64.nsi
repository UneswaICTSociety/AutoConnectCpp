; NSIS Installer Script for UNESWA WiFi AutoConnect (x64/64-bit)
...
!define APP_URL ""
!define APP_DESCRIPTION "Automated WiFi connection tool for UNESWA students (64-bit)"
!define ARCH "x64"

; Installer properties
Name "${APP_NAME} (${ARCH})"
OutFile "UNESWA_AutoConnect_Setup_x64.exe"
...
!define MUI_WELCOMEPAGE_TEXT "This wizard will guide you through the installation of ${APP_NAME} (64-bit version).$\r$\n$\r$\nSolution for students by students - ICT Society, University of Eswatini.$\r$\n$\r$\nClick Next to continue."
...
Section "!${APP_NAME} (required)" SecMain
  ...
  ; Copy main executable (64-bit build)
  File "build_x64\Release\AutoConnect.exe"
  
  ; Copy 64-bit DLLs
  File "build_x64\Release\slint_cpp.dll"
  File "build_x64\Release\libcurl.dll"
  File "build_x64\Release\cpr.dll"
